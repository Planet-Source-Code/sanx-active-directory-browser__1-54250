...
aryContainer = split(strContact, ",")

Set obj = GetObject("LDAP://" & ldapEncode(strContact))
...
<TABLE WIDTH="800px" STYLE="border: 1px solid gray;" CELLSPACING=0 CELLPADDING=0 BORDER=0>
	<TR>
		<TD WIDTH="200px" ALIGN="center" STYLE="background: #74AAD7;" VALIGN="top"><IMG SRC="iconContact.gif" ALT="" WIDTH="128" HEIGHT="128" BORDER="0"></TD>
...
%>
	...
	<TR>
		<TD WIDTH="200px" STYLE="padding: 10px; background: #74AAD7;" VALIGN="top">
			<DIV STYLE="font-size: 10pt; font-weight: bold; padding-bottom: 5px;">Contact Tasks</DIV>
			<A HREF="deleteObject.asp?obj=<%=strContact%>">Delete contact</A>
		</TD>
	</TR>
	<TR>
		<TD WIDTH="200px" STYLE="padding: 10px; background: #74AAD7;" VALIGN="top">
